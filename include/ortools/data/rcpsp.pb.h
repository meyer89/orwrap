...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ortools_2fdata_2frcpsp_2eproto 

namespace protobuf_ortools_2fdata_2frcpsp_2eproto {
...
class Resource : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.Resource) */ {
 public:
  Resource();
  virtual ~Resource();
 ...
 private:
  ...
  friend struct ::protobuf_ortools_2fdata_2frcpsp_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Recipe : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.Recipe) */ {
 public:
  Recipe();
  virtual ~Recipe();
  ...
  inline Recipe* New() const final {
    return CreateMaybeMessage<Recipe>(NULL);
  }
 ...
 private:
  ...
  mutable int _resources_cached_byte_size_;
...
class PerRecipeDelays : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.PerRecipeDelays) */ {
 public:
  PerRecipeDelays();
  ...
  inline PerRecipeDelays* New() const final {
    return CreateMaybeMessage<PerRecipeDelays>(NULL);
  }
 ...
 private:
  ...
  mutable int _min_delays_cached_byte_size_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_ortools_2fdata_2frcpsp_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class PerSuccessorDelays : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.PerSuccessorDelays) */ {
 public:
  PerSuccessorDelays();
  ...
  inline PerSuccessorDelays* New() const final {
    return CreateMaybeMessage<PerSuccessorDelays>(NULL);
  }
...
class Task : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.Task) */ {
 public:
  Task();
  virtual ~Task();
...
class RcpspProblem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.rcpsp.RcpspProblem) */ {
 public:
  RcpspProblem();
  ...
  inline RcpspProblem* New() const final {
    return CreateMaybeMessage<RcpspProblem>(NULL);
  }
