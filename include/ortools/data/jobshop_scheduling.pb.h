...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ortools_2fdata_2fjobshop_5fscheduling_2eproto 

namespace protobuf_ortools_2fdata_2fjobshop_5fscheduling_2eproto {
...
class Task : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.Task) */ {
 public:
  Task();
  virtual ~Task();
 ...
 private:
  ...
  mutable int _machine_cached_byte_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 > duration_;
  mutable int _duration_cached_byte_size_;
  ::google::protobuf::RepeatedField< ::google::protobuf::int64 > cost_;
  mutable int _cost_cached_byte_size_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_ortools_2fdata_2fjobshop_5fscheduling_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Job : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.Job) */ {
 public:
  Job();
  virtual ~Job();
...
class TransitionTimeMatrix : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.TransitionTimeMatrix) */ {
 public:
  ...
  inline TransitionTimeMatrix* New() const final {
    return CreateMaybeMessage<TransitionTimeMatrix>(NULL);
  }
 ...
 private:
  ...
  mutable int _transition_time_cached_byte_size_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_ortools_2fdata_2fjobshop_5fscheduling_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class Machine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.Machine) */ {
 public:
  Machine();
  virtual ~Machine();
...
class JobPrecedence : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.JobPrecedence) */ {
 public:
  JobPrecedence();
  ...
  inline JobPrecedence* New() const final {
    return CreateMaybeMessage<JobPrecedence>(NULL);
  }
...
class JsspInputProblem : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.JsspInputProblem) */ {
 public:
  JsspInputProblem();
  ...
  inline JsspInputProblem* New() const final {
    return CreateMaybeMessage<JsspInputProblem>(NULL);
  }
...
class AssignedTask : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.AssignedTask) */ {
 public:
  AssignedTask();
  ...
  inline AssignedTask* New() const final {
    return CreateMaybeMessage<AssignedTask>(NULL);
  }
...
class AssignedJob : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.AssignedJob) */ {
 public:
  AssignedJob();
  virtual ~AssignedJob();
  ...
  inline AssignedJob* New() const final {
    return CreateMaybeMessage<AssignedJob>(NULL);
  }
...
class JsspOutputSolution : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.data.jssp.JsspOutputSolution) */ {
 public:
  JsspOutputSolution();
  ...
  inline JsspOutputSolution* New() const final {
    return CreateMaybeMessage<JsspOutputSolution>(NULL);
  }
...
inline bool Job::has_earliest_start() const {
  return this != internal_default_instance() && earliest_start_ != NULL;
}
...
inline void Job::clear_early_due_date() {
  early_due_date_ = GOOGLE_LONGLONG(0);
}
...
inline void Job::clear_late_due_date() {
  late_due_date_ = GOOGLE_LONGLONG(0);
}
...
inline void Job::clear_earliness_cost_per_time_unit() {
  earliness_cost_per_time_unit_ = GOOGLE_LONGLONG(0);
}
...
inline void Job::clear_lateness_cost_per_time_unit() {
  lateness_cost_per_time_unit_ = GOOGLE_LONGLONG(0);
}
...
inline bool Job::has_latest_end() const {
  return this != internal_default_instance() && latest_end_ != NULL;
}
...
inline bool Machine::has_transition_time_matrix() const {
  return this != internal_default_instance() && transition_time_matrix_ != NULL;
}
inline void Machine::clear_transition_time_matrix() {
  if (GetArenaNoVirtual() == NULL && transition_time_matrix_ != NULL) {
    delete transition_time_matrix_;
  }
  transition_time_matrix_ = NULL;
}
...
inline const ::operations_research::data::jssp::TransitionTimeMatrix& Machine::transition_time_matrix() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::operations_research::data::jssp::TransitionTimeMatrix*>(
...
inline ::operations_research::data::jssp::TransitionTimeMatrix* Machine::mutable_transition_time_matrix() {
  ...
  if (transition_time_matrix_ == NULL) {
...
inline void JsspInputProblem::clear_makespan_cost_per_time_unit() {
  makespan_cost_per_time_unit_ = GOOGLE_LONGLONG(0);
}
...
inline bool JsspInputProblem::has_scaling_factor() const {
  return this != internal_default_instance() && scaling_factor_ != NULL;
}
...
inline void AssignedJob::clear_due_date_cost() {
  due_date_cost_ = GOOGLE_LONGLONG(0);
}
...
inline void AssignedJob::clear_sum_of_task_costs() {
  sum_of_task_costs_ = GOOGLE_LONGLONG(0);
}
...
inline void JsspOutputSolution::clear_makespan_cost() {
  makespan_cost_ = GOOGLE_LONGLONG(0);
}
