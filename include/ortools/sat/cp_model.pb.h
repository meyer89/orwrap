...
template<> ::operations_research::sat::AutomataConstraintProto* Arena::CreateMaybeMessage<::operations_research::sat::AutomataConstraintProto>(Arena*);
...
class AutomataConstraintProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.sat.AutomataConstraintProto) */ {
 public:
  ...
  #if LANG_CXX11
  AutomataConstraintProto(AutomataConstraintProto&& from) noexcept
    : AutomataConstraintProto() {
    *this = ::std::move(from);
  }

  inline AutomataConstraintProto& operator=(AutomataConstraintProto&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(AutomataConstraintProto& a, AutomataConstraintProto& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline AutomataConstraintProto* New() const final {
    return CreateMaybeMessage<AutomataConstraintProto>(NULL);
  }

  AutomataConstraintProto* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<AutomataConstraintProto>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ConstraintProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.sat.ConstraintProto) */ {
 public:
  ...
  private:
  const ::operations_research::sat::AutomataConstraintProto& _internal_automata() const;
  public:
...
inline const ::operations_research::sat::AutomataConstraintProto& ConstraintProto::_internal_automata() const {
...
inline const ::operations_research::sat::AutomataConstraintProto& ConstraintProto::automata() const {
  ...
  return has_automata()
      ...
      : *reinterpret_cast< ::operations_research::sat::AutomataConstraintProto*>(&::operations_research::sat::_AutomataConstraintProto_default_instance_);
}
inline ::operations_research::sat::AutomataConstraintProto* ConstraintProto::mutable_automata() {
  if (!has_automata()) {
    clear_constraint();
    set_has_automata();
    constraint_.automata_ = CreateMaybeMessage< ::operations_research::sat::AutomataConstraintProto >(
        GetArenaNoVirtual());
  }
