...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ortools_2fglop_2fparameters_2eproto 
...
class GlopParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.glop.GlopParameters) */ {
 public:
  ...
  inline GlopParameters* New() const final {
    return CreateMaybeMessage<GlopParameters>(NULL);
  }
 ...
 private:
  ...
  void set_has_change_status_to_imprecise();
  void clear_has_change_status_to_imprecise();
...
inline void GlopParameters::set_has_change_status_to_imprecise() {
  _has_bits_[1] |= 0x00000002u;
}
inline void GlopParameters::clear_has_change_status_to_imprecise() {
  _has_bits_[1] &= ~0x00000002u;
}
inline void GlopParameters::clear_change_status_to_imprecise() {
  change_status_to_imprecise_ = true;
  clear_has_change_status_to_imprecise();
}
...
inline void GlopParameters::set_change_status_to_imprecise(bool value) {
  set_has_change_status_to_imprecise();
